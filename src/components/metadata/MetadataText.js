...
function MetadataText({
  ...
  const mutationPayload = `{"annotation_type":"task_response_free_text","set_fields":"{\\"response_free_text\\":\\"${metadataValue}\\"}"}`;
    ...
    <>
      {hasData && !isEditing ? (
        ...
        <>
          ...
          <Button onClick={() => handleSave(mutationPayload)}>Save</Button>
        </>
      )}
    </>
  );
