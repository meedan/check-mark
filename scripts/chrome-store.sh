...
# You should fill in config.json a googleClientId from https://console.developers.google.com/apis/credentials?project=bridge-client
...
curl -H "Authorization: Bearer $token" -H "x-goog-api-version: 2" -X PUT -T "releases/bridge-$name.zip" https://www.googleapis.com/upload/chromewebstore/v1.1/items/$appid
echo
